...
long map2(long x, long in_min, long in_max, long out_min, long out_max)
{
 return (x - in_min) * (out_max - out_min) / (in_max - in_min) + out_min;
	...
	int getBatpackSOC(int Stackvoltage){
...
int main()
{
int soc,dod;//stackvol=40570 for dod & 34800 for soc
int Stackvoltage=41237;
float soc1,dod1;
char flag=0;
...
if(ibat>0){
    ...
    soc1=soc1+current;
    soc1=(soc1/Bat_Ah)*100;
  
    printf("\nsoc:%.2f%\n",soc1);
    soc1=soc1*Bat_Ah;
    soc1=soc1/100;
    printf("final soc:%.2fAh",soc1);
}
if(ibat<0){
  
    soc1=soc1-current;
  
    dod1=(soc1/Bat_Ah)*100;
    dod1=100-dod1;

    printf("\ndod:%.2f%\n",dod1);
    dod1=dod1*Bat_Ah;
    dod1=dod1/100;
    printf("final dod:%.2fAh",dod1);
